...
export default function UploadDataModule() {
	...
	const postData = () => {
		...
		axios
			.post(`${epgpApi.baseUrl}/Uploads/epgp`, jsonInput, {
				headers: {
					'X-API-KEY': `${epgpApi.apiKey}`,
				...
				{warning && (
					<div className="rounded-md bg-secondary p-4 flex items-center align-middle font-poppins">
						...
						<p className="ml-3 text-sm font-medium text-gray">
							It seems like the text you inputted is not a JSON file. Make sure you
							copy everything and try again.
						</p>
					</div>
				)}
