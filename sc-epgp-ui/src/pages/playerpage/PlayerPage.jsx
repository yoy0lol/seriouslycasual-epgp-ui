    ...
    <div className='flex flex-col flex-grow'>
      <div className='grid grid-cols-5 flex-grow h-8 gap-6'>
        ...
        <div className='hidden md:block md:col-start-1 col-span-2'>
          {avatar && <div className='bg-no-repeat bg-center h-full rounded-3xl ' style={{ backgroundImage: `url(${avatar})` }}></div>}
          {!avatar && (
        ...
        <div className='col-end-6 col-span-full sm:col-span-3 flex flex-col overflow-y-auto'>
          ...
          <div className='pb-5'>
            ...
            <h1 className='font-poppins font-black text-4xl'>Loot History</h1>
          </div>
